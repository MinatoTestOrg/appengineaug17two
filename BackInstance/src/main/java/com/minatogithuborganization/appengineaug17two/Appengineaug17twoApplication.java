package com.minatogithuborganization.appengineaug17two;
...
@SpringBootApplication(scanBasePackages = {"com.vs.rappit","com.vs","com.minatogithuborganization.appengineaug17two"})
@EnableCaching
...
public class Appengineaug17twoApplication {

	public static void main(String[] args) {
		SpringApplication.run(Appengineaug17twoApplication.class, args);
	}
