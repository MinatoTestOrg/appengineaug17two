...
public class Aug17twoBaseService<T extends Aug17twoBase> extends BaseBusinessLogic<T>
		implements IAug17twoBaseService<T> {
	...
	@Autowired
	private  Aug17twoPerimeterBaseImpl aug17twoPerimeterBaseImpl;
	
	public Aug17twoBaseService(Class<T> modelClass) {
		super(modelClass);
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogService.createChangeLog("Aug17two", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogService.createChangeLog("Aug17two", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogService.createChangeLog("Aug17two", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
	...
	protected IPerimeterManager<T> getPerimeterManager() {
		return aug17twoPerimeterBaseImpl;
	}
}